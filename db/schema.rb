...
ActiveRecord::Schema.define(version: 2019_05_16_184549) do
  ...
  create_table 'covers', force: :cascade do |t|
    ...
    t.index %w[game_id], name: 'index_covers_on_game_id'
  end
  ...
  create_table 'game_collection_items', force: :cascade do |t|
    ...
    t.index %w[game_collection_id],
            name: 'index_game_collection_items_on_game_collection_id'
    t.index %w[game_id], name: 'index_game_collection_items_on_game_id'
    t.index %w[platform_id], name: 'index_game_collection_items_on_platform_id'
  end
  ...
  create_table 'game_collections', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[user_id], name: 'index_game_collections_on_user_id'
  end
  ...
  create_table 'game_developers', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[company_id], name: 'index_game_developers_on_company_id'
    t.index %w[game_id], name: 'index_game_developers_on_game_id'
  end
  ...
  create_table 'game_mode_items', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[game_id], name: 'index_game_mode_items_on_game_id'
    t.index %w[game_mode_id], name: 'index_game_mode_items_on_game_mode_id'
  end
  ...
  create_table 'game_platforms', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[game_id], name: 'index_game_platforms_on_game_id'
    t.index %w[platform_id], name: 'index_game_platforms_on_platform_id'
  end
  ...
  create_table 'game_publishers', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[company_id], name: 'index_game_publishers_on_company_id'
    t.index %w[game_id], name: 'index_game_publishers_on_game_id'
  end
  ...
  create_table 'multiplayer_modes', force: :cascade do |t|
    ...
    t.bigint 'game_id'
    t.bigint 'platform_id'
    t.index %w[game_id], name: 'index_multiplayer_modes_on_game_id'
    t.index %w[platform_id], name: 'index_multiplayer_modes_on_platform_id'
  end
